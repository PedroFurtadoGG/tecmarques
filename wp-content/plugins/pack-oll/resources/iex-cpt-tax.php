<?php
if(!function_exists('iex_cpt')) {

	function iex_cpt($name, $label, $type, $slug, $hierachical, $suports, $icon='dashicons-admin-post'){
...
if(!function_exists('iex_tax')) {

function iex_tax($tax, $labelsingular, $label, $cpts, $showAdmin, $slug, $showMenu){
	    $labels = array(
			'name'                       => $label,
...
function iex_noSpecialChars($string, $space = true) {
