        ...
        <div class="gutter-l">
                            ...
                            <div class="featured-align-img" data-atomic="o-h p-r">
                                <div data-atomic="d-t w-100 h-100">
                                    <div data-atomic="d-tc ta-c va-m">
                                        ...
                                        <img alt="asdf" class="featured--img img-main" src="<?php bloginfo('template_directory'); ?>/assets/tim.php?src=<?= $url; ?>&w=353&h=450&zc=2">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="media">
                            ...
                            <div class="media--content" data-atomic="o-h">
                                ...
                                <div class="featured-align-img" data-atomic="o-h p-r">
                                    ...
                                    <div data-atomic="d-t w-100 h-100">
                                        <div data-atomic="d-tc ta-c va-m">
                                            <img alt="asdf" class="featured--img thumb-img" src="<?php echo $image['url']; ?>">
                                        </div>
                                    </div>
            ...
            <div class="page-content--block" data-grid="s-1 m-3x2 l-3x2">
                <header data-atomic="p-r">
                    <h1 class="heading-alt c-brand"><?php the_title();?></h1>
            ...
            <ul class="simpleTabsNavigation">
                ...
                <?php if( have_rows('nx_outros_dados') ): ?>
                    <?php while( have_rows('nx_outros_dados') ): the_row(); $tituloTab = get_sub_field('nx_titulo_aba'); ?>
                        <li data-tab="<?php the_ID(); ?>"><a href="#"><h3><?= $tituloTab; ?></h3></a></li>
                    <?php endwhile; ?>
                <?php endif; ?>
            </ul>
...
<!--P{$post->ID}M{$codigo}-->
                        <tr class="product-model oll-item" id="product[<?php echo $i; ?>]">
                            <td class="td-1 product-model--code" data-atomic="w-10"><?php echo "{$codigo}";?></td>
...
<!--                            <td class="td-3 product-model--size" data-atomic="w-10"><?= $tamanho; ?></td>-->
                            ...
                            <td class="td-5 product-model--add" data-atomic="w-20">
                                <button class="btn-black c-brand oll-add" type="button" data-productid="<?php echo $post->ID;?>" data-productname="<?php echo get_the_title();?>" data-modelcode="<?php echo "{$codigo}";?>" data-modelname="<?php echo $descricao;?>">
            ...
            <?php if( have_rows('nx_outros_dados') ): ?>
                <?php while( have_rows('nx_outros_dados') ): the_row(); $textoTab = get_sub_field('nx_conteudo_da_aba'); ?>
                    <div class="simpleTabsContent oll-tab-<?php the_ID(); ?>" data-atomic="mt-xs p-m">
                        <?= $textoTab; ?>
                    </div>
                <?php endwhile; ?>
            <?php endif; ?>
